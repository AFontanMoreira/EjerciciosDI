...
class Aplicacion(Gtk.Window):
    ...
    def __init__(self):
        super().__init__(title="Ex de uso de Gtk FlowBox")
        ...
        boton2 = Gtk.Button()
        boton2.add(Gtk.Arrow(arrow_type=Gtk.ArrowType.LEFT, shadow_type=Gtk.ShadowType.NONE))
        caixa.add(boton2)
        ...
        for n in range(50):
            cadro = CaixadeBotons.CaixaDeBotons()
            flowbox.add(cadro)
